    ...
    <>
      ...
      <div className="min-h-screen bg-white relative overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="lg:hidden rounded-[48px] overflow-hidden flex flex-col relative" style={{ marginTop: "4rem", marginBottom: "4rem" }}>
                ...
                {WHY_ITEMS.map((item) => (
                  <div key={item.title} className="space-y-3">
                    <div className="chip-white">
                      <h3 className="font-h2 text-h2 text-glowly-black">{item.title}</h3>
                    </div>
              ...
              <div className="flex items-end justify-center relative" style={{ minHeight: "300px", zIndex: 2 }}>
                <img src="/images/why/master.webp" alt="Experienced nail technician at LS Beauty Salon Paoli PA" className="w-auto object-contain" style={{ maxHeight: "320px" }} loading="lazy" width="320" height="320" />
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-6">
            ...
            <div className="max-w-2xl mx-auto rounded-[36px] overflow-hidden shadow-2xl">
              <div className="relative" style={{ height: "280px" }}>
                <img src="/images/why/LSBeauty-location.webp" alt="LS Beauty Salon interior Paoli PA" className="w-full h-full object-cover" loading="lazy" />
        ...
        <section id="faq" className="py-16 lg:py-24 bg-white" aria-label="Frequently Asked Questions">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="font-h1 text-h1 lg:text-h1 text-center text-glowly-black mb-12">
...
//           alignItems: "center",
//           animation: "introLogo 0.7s cubic-bezier(0.16,1,0.3,1) forwards",
//         }}
//       >
//         <span
//           style={{
...
//             marginTop: "6px",
//             animation: "introSub 0.6s 0.3s cubic-bezier(0.16,1,0.3,1) both",
//           }}
//         >
//           Salon &amp; Spa
//         </span>
...
//             marginTop: "12px",
//             height: "2px",
//             background: "linear-gradient(90deg, #0097A7, #49d0c9)",
//             animation: "introLine 0.6s 0.5s cubic-bezier(0.16,1,0.3,1) both",
//             width: 0,
//           }}
//         />
//       </div>
...
//       {services.map((service, index) => {
//         const isOpen = false;
//         const priceLabel = isNaN(Number(service.fromPrice))
//           ? service.fromPrice
//           : `$${service.fromPrice}`;
...
//             className="relative"
//             style={{
//               animation: `fadeSlideUp 0.5s ${index * 0.06}s both`,
//             }}
//           >
//             {service.isSignature && (
//               <div className="absolute -top-3 left-6 z-20 bg-glowly-action-orange text-white text-[14px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
//                 Signature
//               </div>
//             )}
...
//               <div className="w-full flex items-center justify-between px-4 lg:px-7 py-3 lg:py-5 text-left gap-2">
//                 <div className="flex items-center min-w-0 flex-1">
//                   <span className="font-cormorant-heading text-xl lg:text-5xl text-glowly-black truncate">
//                     {service.name}
//                   </span>
//                 </div>
...
//                 <div className="flex items-center gap-3 lg:gap-6 flex-shrink-0">
//                   <div className="flex items-center gap-1.5 lg:gap-2">
//                     <span className="font-sans text-[10px] lg:text-sm text-glowly-black/60 uppercase tracking-tighter">
//                       From
//                     </span>
//                     <span className="font-display text-2xl lg:text-3xl text-glowly-black whitespace-nowrap">
//                       {priceLabel}
//                     </span>
//                   </div>
...
//               aria-expanded={open === i}
//             >
//               <span className="font-cormorant-heading text-lg lg:text-xl text-glowly-black pr-4">
//                 {item.q}
//               </span>
//               <div
//                 className="flex-shrink-0 w-9 h-9 rounded-full bg-glowly-orange/90 flex items-center justify-center transition-transform duration-300"
...
//       <div className="min-h-screen bg-white relative overflow-x-hidden">
//         {/* Background gradient — desktop only, no CLS impact */}
//         <div
//           className="hidden lg:block absolute top-0 right-0 pointer-events-none z-0"
//           aria-hidden="true"
//           style={{
...
//         <section id="services" className="relative py-16 lg:py-24" aria-label="Our Services">
//           <div className="max-w-7xl mx-auto px-6">
//             <h2 className="font-cormorant-heading text-5xl lg:text-5xl text-center text-glowly-black mb-12">
//               Services
//             </h2>
//             <ServicesAccordion />
//           </div>
...
//         {/* ── Services → Reviews divider: цветочек + линии ── */}
//         <div className="relative h-0 overflow-visible pointer-events-none" aria-hidden="true" style={{ zIndex: 10 }}>
//           {/* Размытый переход сверху секции Reviews */}
//           <div style={{
//             position: "absolute",
//             top: 0,
//             left: 0,
...
//         >
//           {/* Размытые края секции — сверху и снизу */}
...
//             <h2 className="font-cormorant-heading text-3xl lg:text-4xl text-center mb-12 text-glowly-black">
//               Reviews from{" "}
...
//                   {
//                     name: "Sviatoslav",
//                     text: "I'm happy with my experience with LS Beauty Salon. Olivia (Hairstylist) and Juliana (Nail technician) were so friendly, attentive, and professional. I'm delighted with their work!",
//                   },
//                   {
//                     name: "Halyna G",
//                     text: "I'm happy with my experience with LS Beauty Salon. Olivia (Hairstylist) and Juliana (Nail technician) were so friendly, attentive, and professional. I'm delighted with their work!",
...
//                   {
//                     name: "Alia N.",
//                     text: "I had my nails done with Lina - she is the best! I'm happy with my nails — color, clean cuticle, shape! She is amazing! Clean tools, nice interior, coffee and tea. Also had my eyelash extension and eyebrows shaping with Anna. Lashes look so natural, eyebrows have a perfect shape. 10/10. Will definitely be returning!",
//                   },
//                   {
//                     name: "Al",
//                     text: "I showed the nail artist a picture from Pinterest, and they not only replicated it flawlessly but also customized the color to perfection. The attention to detail and level of customization truly exceeded my expectations. I highly recommend them to anyone looking for top-notch nail services.",
//                   },
//                   {
//                     name: "Kelly",
//                     text: "I had eyelash extensions done at LS salon with Anna. I am delighted! Anna was truly attentive to all my requests and the result is absolutely amazing! I will definitely come to her again for permanent makeup too. I recommend Anna at LS salon to everyone as a highly qualified professional!",
//                   },
//                 ].map((rev, i) => (
//                   <article
//                     key={i}
//                     role="listitem"
//                     className="min-w-[300px] md:min-w-[350px] bg-white rounded-[32px] p-6 border border-glowly-lavender/30 shadow-sm snap-start"
//                     itemScope
//                     itemType="https://schema.org/Review"
//                   >
//                     <div className="flex items-center gap-3 mb-4">
//                       <div
//                         className="w-10 h-10 bg-glowly-orange/70 rounded-full flex items-center justify-center text-white font-display font-bold"
//                         aria-hidden="true"
//                       >
//                         {rev.name[0]}
//                       </div>
...
//                         </div>
//                         <div
//                           className="flex text-glowly-orange text-xs"
...
//                     </div>
//                     <p
//                       className="font-sans text-base font-medium text-black mb-4 line-clamp-4"
//                       itemProp="reviewBody"
//                     >
//                       {rev.text}
//                     </p>
//                     <div className="rounded-2xl overflow-hidden h-40 bg-glowly-lavender/10 flex items-center justify-center">
//                       <span className="text-glowly-lavender text-xs font-sans italic">
//                         Review Image
//                       </span>
//                     </div>
//                   </article>
...
//               __html: `#reviews-container::-webkit-scrollbar { display: none; }`,
//             }}
//           />
//         </section>
...
//           aria-label="Why Choose LS Beauty"
//         >
//           <div className="max-w-7xl mx-auto px-6">
...
//               <div className="p-8 flex flex-col gap-8 relative" style={{ zIndex: 2 }}>
//                 {[
//                   { title: "Experienced Team", desc: <>Skilled nail technicians with <span className="font-bold text-xl text-glowly-action-orange">5+ years of experience</span>.</> },
//                   { title: "Maintenance On Us", desc: <>Our <span className="font-bold text-xl text-glowly-action-orange">10-day guarantee</span> covers your manicure.</> },
//                   { title: "Complete Service", desc: <>One price covers everything from removal to design.</> },
//                 ].map((item) => (
//                   <div key={item.title} className="space-y-3">
//                     <div className="bg-white/90 rounded-full px-6 py-2 w-fit shadow-sm">
//                       <h3 className="font-display text-2xl text-glowly-black">{item.title}</h3>
//                     </div>
//                     <p className="font-sans text-xl text-white leading-relaxed drop-shadow">{item.desc}</p>
//                   </div>
//                 ))}
//               </div>
//               <div className="flex items-end justify-center relative" style={{ minHeight: "300px", zIndex: 2 }}>
...
//             {/* ── Desktop ── */}
//             {/* Внешний контейнер — overflow visible чтобы мастер выходил вверх */}
//             <div
//               className="relative hidden lg:flex flex-row items-stretch"
//               style={{ minHeight: "550px", overflow: "visible" }}
//             >
//               {/* ЕДИНЫЙ фон — растянут на оба блока сразу */}
//               <div
//                 aria-hidden="true"
//                 style={{
//                   position: "absolute",
...
//               {/* Левый блок — мастер выходит за верхний край */}
//               <div
//                 className="relative hidden lg:flex items-end justify-center"
//                 style={{
//                   marginLeft: "calc(-1 * (max(0px, (100vw - 1280px) / 2) + 1.5rem))",
...
//                       <h3 className="font-display text-2xl text-glowly-black">{item.title}</h3>
//                     </div>
//                     <p className="font-sans text-white text-xl leading-relaxed max-w-md drop-shadow">{item.desc}</p>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//             <h2 className="font-display text-4xl lg:text-5xl text-center text-glowly-black mb-4">
//               Visit <span className="text-glowly-action-orange">Us</span>
//             </h2>
//             <p className="font-sans text-lg text-center text-glowly-black/ mb-10 lg:mb-16">
//               Your destination for beauty, relaxation &amp; rejuvenation
//             </p>
...
//               <div className="relative" style={{ height: "280px" }}>
//                 <img
//                   src="/images/why/LSBeauty-location.webp"
//                   alt="LS Beauty Salon interior Paoli PA"
//                   className="w-full h-full object-cover"
//                   loading="lazy"
//                 />
//                 {/* лёгкий градиент снизу для плавного перехода */}
//                 <div
//                   aria-hidden="true"
//                   style={{
//                     position: "absolute",
...
//                 <div>
//                   <h3 className="font-display text-3xl text-glowly-black mb-1">LS Beauty Salon</h3>
//                   <p className="font-sans text-base text-glowly-black/60">Paoli, Pennsylvania</p>
//                 </div>
 
//                 <address className="not-italic flex flex-col items-center gap-3 w-full">
//                   <a
//                     href="tel:+12679624747"
//                     className="font-sans text-lg font-bold text-glowly-black hover:text-glowly-action-orange transition-colors"
//                   >
//                     (267) 962-4747
//                   </a>
//                   <p className="font-sans text-base text-glowly-black/70">
...
//                 <div className="w-full rounded-2xl px-6 py-4 space-y-2">
//                   <div className="flex justify-between items-center">
//                     <span className="font-sans text-xs font-bold uppercase tracking-widest text-glowly-black/90">Mon — Sat</span>
//                     <span className="font-sans font-bold text-glowly-black">8:30am – 7:00pm</span>
//                   </div>
//                   <div className="flex justify-between items-center">
//                     <span className="font-sans text-xs font-bold uppercase tracking-widest text-glowly-black/90">Sunday</span>
//                     <span className="font-sans text-sm italic text-glowly-black/60">By appointment only</span>
//                   </div>
//                 </div>
...
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="flex-1 inline-flex justify-center items-center px-6 py-3 bg-glowly-orange text-white font-sans text-sm font-black uppercase tracking-widest rounded-full shadow-lg hover:scale-105 active:scale-95 transition-all duration-300"
//                   >
//                     Get Directions
//                   </a>
//                   <a
...
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="flex-1 inline-flex justify-center items-center px-6 py-3 border-2  bg-glowly-action-orange text-glowly-white font-sans text-sm font-black uppercase tracking-widest rounded-full hover:bg-glowly-orange hover:text-white transition-all duration-300"
//                   >
//                     Book Now
//                   </a>
//                 </div>
 
//                 <p className="font-sans text-[11px] text-glowly-black/40 italic">
//                   * We recommend booking in advance to secure your preferred time.
//                 </p>
//               </div>
//             </div>
...
//               </div>
//             </div>
//             <h2 className="font-display text-3xl lg:text-4xl text-glowly-black mb-3">Gift Cards are here!</h2>
//             <a
//               href="https://www.vagaro.com/Users/BusinessWidget.aspx?enc="
//               target="_blank"
//               rel="noopener noreferrer"
