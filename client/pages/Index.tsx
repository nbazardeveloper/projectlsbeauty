            ...
            >
              <div className="w-full flex items-center justify-between px-4 lg:px-7 py-3 lg:py-5 text-left gap-2">
                <div className="flex items-center gap-3 lg:gap-4 min-w-0 flex-1">
                  ...
                  <span
                    className={`font-display text-glowly-black truncate ${
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex text-glowly-orange text-xs">
                        ★★★★★
                      </div>
                    </div>
                  </div>
            ...
            <div className="p-8 flex flex-col gap-8">
              <div className="space-y-3">
                <div className="bg-white rounded-full px-6 py-2 w-fit shadow-sm">
                  <h3 className="font-display text-2xl text-glowly-black">
                    Experienced Team
                  </h3>
                </div>
              ...
              <div className="space-y-3">
                ...
                <p className="font-sans text-xl text-glowly-black/80 leading-relaxed">
                  Our{" "}
                  <span className="font-bold text-xl">10-day guarantee</span>{" "}
                  covers your manicure.
                </p>
              </div>
              <div className="space-y-3">
                <div className="bg-white rounded-full px-6 py-2 w-fit shadow-sm">
                ...
                <div className="w-full bg-white/90 backdrop-blur-md rounded-[28px] p-6 lg:p-10 border border-white/90 shadow-inner">
                  ...
                  <div className="space-y-4 font-sans">
                    <div className="flex justify-between items-center border-b border-glowly-black/5 pb-3">
                      <span className="text-glowly-black/60 uppercase text-[10px] lg:text-xs font-bold tracking-widest">
                        Mon — Sat
                      </span>
                      <span className="text-glowly-black font-bold text-base lg:text-lg">
                        8:30am – 7:00pm
                      </span>
                    </div>
                  ...
                  <div className="mt-8 p-4 bg-white/40 rounded-2xl">
                    <p className="text-[11px] lg:text-xs text-glowly-black/70 leading-relaxed text-center italic">
                      * We recommend booking in advance to secure your preferred
                      time.
                    </p>
                  </div>
                </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
          ...
          >
            ...
            >
              <path
                d="M20 80 Q 60 40 80 20"
                stroke="rgba(92,225,230,0.3)"
                strokeWidth="1.5"
                fill="none"
              />
              <path
                d="M10 110 Q 50 70 90 50"
                stroke="rgba(92,225,230,0.25)"
                strokeWidth="1"
                fill="none"
              />
              <path
                d="M300 80 Q 260 40 240 20"
                stroke="rgba(92,225,230,0.3)"
                strokeWidth="1.5"
                fill="none"
              />
              <path
                d="M310 110 Q 270 70 230 50"
                stroke="rgba(92,225,230,0.25)"
                strokeWidth="1"
                fill="none"
              />
              <path
                d="M20 160 Q 60 180 80 200"
                stroke="rgba(92,225,230,0.3)"
                strokeWidth="1.5"
                fill="none"
              />
              <path
                d="M300 160 Q 260 180 240 200"
                stroke="rgba(92,225,230,0.3)"
                strokeWidth="1.5"
                fill="none"
              />
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(92,225,230,0.6) 0%, rgba(150,140,210,0.7) 100%)",
              }}
            >
              <span className="font-display text-3xl text-white/90 tracking-wide">
                LS Beauty
              </span>
              <span className="font-sans text-xs text-white/60 tracking-widest mt-1">
                Salon &amp; Spa
              </span>
            </div>
          </div>
