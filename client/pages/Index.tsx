              ...
              <div className="w-full flex items-center justify-between px-4 lg:px-7 py-3 lg:py-5 text-left gap-2">
                <div className="flex items-center gap-3 lg:gap-4 min-w-0 flex-1">
                  ...
                  >
                    ...
                    <img
                      src={service.icon}
                      alt={service.name + " service at LS Beauty Salon Paoli PA"}
                  ...
                  <span className="font-display text-xl lg:text-3xl text-glowly-black truncate">
                    {service.name}
                  </span>
                </div>
  ...
  return (
    <>
      ...
      >
        ...
        <section
          id="reviews"
          className="py-16 lg:py-24 bg-glowly-lavender/70 overflow-hidden relative"
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className="w-10 h-10 bg-glowly-lavender rounded-full flex items-center justify-center text-white font-display font-bold"
                        aria-hidden="true"
                      >
                        {rev.name[0]}
                      </div>
        ...
        {/* ── Why Us ── */}
        <section id="why" className="relative py-16 lg:py-24 overflow-hidden" aria-label="Why Choose LS Beauty">
          <div className="max-w-7xl mx-auto px-6">
            {/* Mobile */}
            <div
            ...
            >
              <div className="p-8 flex flex-col gap-8">
                {[
                  { title: "Experienced Team", desc: <>Skilled nail technicians with <span className="font-bold text-xl">5+ years of experience</span>.</> },
                  { title: "Maintenance On Us", desc: <>Our <span className="font-bold text-xl">10-day guarantee</span> covers your manicure.</> },
                  ...
                  <div key={item.title} className="space-y-3">
                    ...
                    <p className="font-sans text-xl text-glowly-black/80 leading-relaxed">{item.desc}</p>
                  </div>
                ))}
              </div>
            ...
            <div className="relative hidden lg:flex flex-row items-stretch">
              ...
              <div
                ...
                style={{ backgroundColor: "rgba(73, 208, 201, 0.8)", borderTopRightRadius: "80px", borderBottomRightRadius: "80px" }}
              >
                {[
                  { title: "Experienced Team", desc: <>Skilled nail technicians with <span className="font-bold text-xl">5+ years of experience</span>.</> },
                  { title: "Maintenance On Us", desc: <>Our <span className="font-bold text-xl">10-day guarantee</span> covers your manicure.</> },
                  ...
                  <div key={item.title} className="space-y-3">
                    ...
                    <p className="font-sans text-glowly-black/80 text-xl leading-relaxed max-w-md">{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section id="locations" className="py-12 lg:py-24" aria-label="Salon Location and Hours">
          <div className="max-w-7xl mx-auto px-4 lg:px-6">
            ...
            >
              <div className="hidden lg:block absolute top-0 right-0 p-10 opacity-10 pointer-events-none" aria-hidden="true">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                    ...
                    <address className="w-full not-italic">
                      <div className="space-y-5">
                        <div className="flex flex-col lg:flex-row items-center gap-3 lg:gap-4">
                          <div className="w-10 h-10 rounded-full bg-white/30 flex items-center justify-center flex-shrink-0" aria-hidden="true">
                          ...
                          <a
                            ...
                            className="font-sans text-xl font-bold text-glowly-black hover:text-glowly-action-orange transition-colors"
                          >
                            (267) 962-4747
                          </a>
                        </div>
                  ...
                  <div className="w-full bg-white/90 backdrop-blur-md rounded-[28px] p-6 lg:p-10 border border-white/90 shadow-inner">
                    <h3 className="font-display text-2xl text-glowly-black mb-6 text-center lg:text-left">
                      Opening Hours
                    </h3>
                    <div className="space-y-4 font-sans">
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-center gap-1 border-b border-glowly-black/5 pb-3 text-center sm:text-left">
                        ...
                        <span className="text-glowly-black font-medium text-sm italic opacity-80">By special appointment only</span>
                      </div>
                    </div>
