      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12 pb-12 border-b border-glowly-black/10">
          ...
          <div className="lg:col-span-1">
            {/* Libre Baskerville for brand name */}
            <span
              className="font-libre-heading text-glowly-black tracking-wide block"
              style={{ fontSize: "var(--fs-display-xl)" }}
            >
              LS Beauty
            </span>
            <p
              className="font-sans text-glowly-black/60 tracking-widest mt-1 mb-5"
              style={{ fontSize: "var(--fs-body-xxs)" }}
            >
              Salon &amp; Spa
            </p>
            <p
              className="font-sans text-glowly-black/80 leading-relaxed max-w-xs"
          ...
          <div className="border-b lg:border-none border-glowly-black/5 pb-4 lg:pb-0">
            ...
            >
              <h4
                className="font-sans font-bold text-glowly-black/90 uppercase tracking-wider lg:mb-5"
                style={{ fontSize: "var(--fs-body-md)" }}
              >
                Menu
              </h4>
              ...
              <ul className="space-y-3">
                {NAV_ITEMS.map(({ label, href }) => (
                  <li key={label}>
                    <a
                      href={href}
                      className="font-sans text-glowly-black/80 hover:text-glowly-black transition-colors"
                      style={{ fontSize: "var(--fs-body-md)" }}
                    >
                      {label}
                    </a>
          ...
          <div className="border-b lg:border-none border-glowly-black/5 pb-4 lg:pb-0">
            ...
            >
              <address
                className="not-italic space-y-1 font-sans text-glowly-black/80"
                style={{ fontSize: "var(--fs-body-md)" }}
              >
                <p>(267) 962-4747</p>
                <p>24 Paoli Pike</p>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 pt-8 text-center lg:text-left">
          <p
            className="font-sans text-glowly-black/50"
            style={{ fontSize: "var(--fs-body-xxs)" }}
          >
          ...
          <div className="flex gap-6">
            {[
              ...
              <a
                key={label}
                href={href}
                className="font-sans text-glowly-black/50 hover:text-glowly-black/80 transition-colors"
                style={{ fontSize: "var(--fs-body-xxs)" }}
              >
                {label}
              </a>
